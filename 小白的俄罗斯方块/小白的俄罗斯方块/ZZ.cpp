...
ZZ::ZZ(void)
{
	...
	block[1][0] = 0,block[1][1] = 1,block[1][2] = 1,block[1][3] = 0;
	squareline = 0;
	squarelist = 3;
	squarenum =	1;
...
void ZZ::Zchangesquare(const bg *ground)
{
	if(1 == ground->background[squareline][squarelist])//0
	{
		...
		point[2].x = 20*(squarelist+1+1);point[2].y = 20*(squareline+1);
		point[3].x = 20*(squarelist+1+1+1)-1;point[3].y = 20*(squareline+1+1)-1;
		point[4].x = 20*(squarelist+1);point[4].y = 20*(squareline+1);
		point[5].x = 20*(squarelist+1+1)-1;point[5].y = 20*(squareline+1+1)-1;
		point[6].x = 20*(squarelist+2-1);point[6].y = 20*(squareline+1+1);
		point[7].x = 20*(squarelist+2-1+1)-1;point[7].y = 20*(squareline+1+1+1)-1;
	...
	else if(1 == ground->background[squareline][squarelist+2])//1
	{
		...
		point[2].x = 20*(squarelist+1+1-1);point[2].y = 20*(squareline+1+1);
		point[3].x = 20*(squarelist+1+1-1+1)-1;point[3].y = 20*(squareline+1+1+1)-1;
		point[4].x = 20*(squarelist+1);point[4].y = 20*(squareline+1);
		point[5].x = 20*(squarelist+1+1)-1;point[5].y = 20*(squareline+1+1)-1;
		point[6].x = 20*(squarelist+2-1-1);point[6].y = 20*(squareline+1+1-1);
		point[7].x = 20*(squarelist+2-1+1-1)-1;point[7].y = 20*(squareline+1+1+1-1)-1;

	}
	else if(1 == ground->background[squareline+2][squarelist+2])//2
	{
		change_background();
		point[0].x = 20*(squarelist+2-1);point[0].y = 20*(squareline);
		point[1].x = 20*(squarelist+2+1-1)-1;point[1].y = 20*(squareline+1)-1;
		point[2].x = 20*(squarelist+1+1-1);point[2].y = 20*(squareline+1);
		point[3].x = 20*(squarelist+1+1+1-1)-1;point[3].y = 20*(squareline+1+1)-1;
		point[4].x = 20*(squarelist+1-1);point[4].y = 20*(squareline+1);
		point[5].x = 20*(squarelist+1+1-1)-1;point[5].y = 20*(squareline+1+1)-1;
		point[6].x = 20*(squarelist+2-1-1);point[6].y = 20*(squareline+1+1);
		point[7].x = 20*(squarelist+2-1+1-1)-1;point[7].y = 20*(squareline+1+1+1)-1;
	}
